...
|---|---|---|---|
| 1 | Dead Sea Scrolls | **PARTIAL** | **Isaiah** 66 ch / 590 variants at `/dss-isaiah/`; **Deuteronomy** 34 ch / 79 attestation entries / 4 theological variants (incl. 32:8 "sons of God", 32:43 longer ending → Heb 1:6) at `/dss-deuteronomy/`. Phase 4 remainder (Psalms 11QPsᵃ, Samuel 4QSamᵃ, plus ~15 fragment-summary files) outstanding. |
