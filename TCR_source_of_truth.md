...
| 5 | Samaritan Pentateuch | **DONE** | 5 books, 156 variants, deployed at `/samaritan-pentateuch/` (Phase 6 gap check pending — verify Deut 27:4 Ebal/Gerizim, Decalogue 11th commandment Gerizim altar, ~6,000 total SP-MT variants of which the most theologically significant are documented). |
| — | Targumim | **PARTIAL** | Onkelos 188 + Jonathan 167 = **355 renderings** (was 329 before Phase 5 batch 1). Comprehensive target ~1,000+. Memra/Shekinah/Yeqara theology, Suffering Servant redistribution, and major messianic re-readings now documented. Multi-session content densification ongoing. |
...
| Date | Changes |
|---|---|
| 2026-05-04 | **TARGUMIM PHASE 5 — FIRST BATCH (+26 marquee renderings).** Phase 5 content expansion: Targum total 329 → 355 entries. Focus on highest-ROI additions — the most-cited Targumic re-readings that were not yet documented. **Onkelos Pentateuch (+12)**: Memra theology (Gen 3:8 Memra walking in garden, 6:6 Memra repenting, Exod 32:14, Deut 4:24 Memra-as-fire vs Heb 12:29's direct identification); theophany handling (Gen 1:26, 18:1, 32:30 Jacob wrestles "the angel of the LORD," Exod 13:21 Yeqara, 33:11 mamlel im mamlel "speech with speech" replaces "face to face"); Shekinah indwelling (Exod 25:8 foundational, Lev 26:12, Num 6:24-26 Priestly Blessing); messianic readings (Gen 49:10 Shiloh→Meshicha, Num 24:17 star→Messianic king). **Jonathan Prophets (+14)**: Suffering Servant redistribution (Isa 53:5 pierced/crushed becomes "shall build up the holy place," 53:7 silent suffering becomes prayer-acceptance, 53:10 will-to-crush-him becomes will-to-refine-the-remnant — the marquee Jewish-Christian exegetical divergence on Isa 53); messianic identifications (Isa 9:6, 11:1, 11:10, 28:16 cornerstone, 42:1, 52:13, Jer 23:5, 33:15, Mic 5:2 Bethlehem, Zech 9:9 Triumphal Entry); Zech 12:10 (the marquee "him whom they pierced" — Targum reformulates to avoid the apparent identification of YHWH with the pierced one, directly relevant to John 19:37's citation); eschatological (Isa 65:17, Zech 14:9, Joel 2:28→Acts 2:17); Jeremiah expansion (Temple Sermon 7:11→Mark 11:17, 17:9 deceitful heart, 18:6 potter-and-clay→Rom 9:21, 31:15 weeping Rachel→Matt 2:18, 31:33 law-on-heart new covenant→Heb 8:10); Leviticus priestly (16:8 Azazel scapegoat lots, 16:30 atonement formula, 17:11 life-in-blood→Heb 9:22, 19:18 love-neighbor, 25:10 Jubilee freedom). Live spot-checks: Genesis 49:10 surfaces Shiloh→Messiah; Jer 31:15 shows Rachel weeping; all new entries appear in inline tradition stacks alongside DSS/LXX/Vulgate. Phase 5 remains a multi-session content track (~1,000 target for comprehensive coverage); the 26-entry batch is the highest-ROI completion of the most-cited Targumic re-readings. Commits: tcr-site `f81e412`, the-covenant-rendering `f730b45`. SOT v5.13. |
| 2026-05-04 | **CROSS-TRADITION CONSISTENCY AUDIT — THREE-TRACK FIX (PHASE 10).** Audit of the now-comprehensive 7-tradition data corpus surfaced 15 actionable inconsistencies. Three highest-impact tracks fixed: (1) **Significance schema normalization.** The schema requires `{theological, major, moderate, minor}`, but 26 specialized values had crept into significance fields across JST and DSS files (`christological` 120×, `eschatological` 155×, `covenantal` 92×, `ethical` 83×, `clarification` 62×, etc.) plus `{high, low, medium}` in Samaritan files. Walked every JSON across both repos; moved the 26 specialized values to a new `category` field, mapped severity terms to canonical equivalents. Final state: **4,015 significance values, 100% canonical** (1,517 minor / 1,274 theological / 760 moderate / 464 major). The TraditionStack component already supported a `category` field — specialized labels now render as a second badge, preserving scholarly precision while satisfying the schema. (2) **Cross-tradition NT-reception backfill.** Vulgate Isaiah 7:14 → 1QIsaᵃ ha-almah cross-ref; Vulgate Isaiah 53:3 → 1QIsaᵃ + Targum cross-ref; Vulgate Isaiah 53:5 → DSS Hebrew → LXX → Vulgate continuity note; **NEW** Vulgate Deuteronomy 32:43 entry — documents the Hebrews 1:6 chain (4QDeutᵍ + LXX preserve the longer-ending Hebrew Vorlage Heb 1:6 cites; Jerome follows the proto-MT shorter form, so the Vulgate does NOT preserve the textual basis of one of the New Testament's most striking Christological citations — a notable theological-history datum now surfaced). Added Deuteronomy to the Vulgate routing config (was 9 routes, now 10). (3) **Manuscript designation canonicalization. 920 replacements across 262 files**: 874× `1QIsaiah-a` → `1QIsaᵃ`; 40× `4QSam-a` → `4QSamᵃ`; plus 4QDeut/4QPs/11QPs/4QpaleoExod variants. Live: zero `1QIsaiah-a` stragglers site-wide. Plus: surfaced Phase 4 DSS coverage to all 33 fragment-attested OT books in /books/ — every Library entry now shows a Dead Sea Scrolls link, resolving via the generalized DSS resolver to either dedicated per-chapter sites or `/dss-fragments#book-*` anchors. Commits: tcr-site `5a4629e` + `abba034`, the-covenant-rendering `cec1908`. SOT v5.12. |
