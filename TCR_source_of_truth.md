...
|---|---|---|---|
| 1 | Dead Sea Scrolls | **PARTIAL** | **Isaiah** 66 ch / 590 variants at `/dss-isaiah/`; **Deuteronomy** 34 ch / 79 attestation entries / 4 theological variants (incl. 32:8 "sons of God", 32:43 longer ending → Heb 1:6) at `/dss-deuteronomy/`; **1 Samuel** 31 ch / 23 attestation entries / 7 variants (incl. the marquee Nahash paragraph at 11:1) at `/dss-1-samuel/`; **2 Samuel** 24 ch / 12 attestation entries / 2 variants (incl. Solomon's-gold-shields at 8:7) at `/dss-2-samuel/`. Phase 4 remainder (Psalms 11QPsᵃ + ~15 fragment-summary files for books with smaller attestation) outstanding. |
